    ...
    <>
      ...
      <div className="min-h-screen w-full bg-background text-foreground">
        ...
        <header className="w-full border-b border-border py-8 px-8 md:px-20 flex flex-col md:flex-row items-start md:items-center md:justify-between bg-gradient-to-br from-white to-slate-100">
          <div className="flex flex-col md:flex-row md:items-center gap-6 w-full">
            ...
            <div className="flex-1">
              ...
              <p className="text-lg text-muted-foreground" role="doc-subtitle">S O F T W A R E &nbsp; E N G I N E E R I N G</p>
        ...
        <main className="w-full px-4 md:px-20 py-10 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-screen-2xl mx-auto">
          <section className="col-span-1 md:col-span-2 space-y-8" aria-label="Main content">
            <BioCard />
          ...
          <aside className="col-span-1 space-y-8" aria-label="Additional information">
            <ReferencePanel />
            <CertificationsList />
          </aside>
        </main>
        <footer className="w-full py-6 px-8 text-center text-xs text-muted-foreground border-t border-border mt-16">
          <div className="flex flex-col md:flex-row items-center justify-center gap-4">
            <span>&copy; {new Date().getFullYear()} Sandun Induwara &mdash; Portfolio</span>
            <ViewCounter />
          </div>
        </footer>
      </div>
